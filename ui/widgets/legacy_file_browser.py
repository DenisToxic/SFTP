"""Legacy file browser implementation (moved from main.py)"""
import os
import stat
import posixpath
import tempfile
...
class LegacyRemoteFileBrowser(QTreeWidget):
    """Legacy remote file browser with drag/drop support"""
    
    def __init__(self, manager):
        """Initialize legacy file browser
